...
def main(
    im_path: str = input("Enter path to image file: "),
    validate_landmarks: bool = input("Enter whether to validate annotated landmarks (True/False): "),
    segment: bool = input("Enter whether to segment channels by the PMC stain (True/False): "),
    pmc_channel: int = int(input("Enter the channel containing the PMC stain (integer): ")),
    z_start: int = int(input("Enter the starting z slice (integer): ")),
    z_stop: int = int(input("Enter the ending z slice (integer): "))
) -> None:
